...
# ╔═╡ 6d1d7f64-be35-11ec-03a9-2340ad415587
begin
	using Plots
	using CUDA
	CUDA.versioninfo()
...
# ╔═╡ b81d223e-cc25-4824-8d95-aa54414a60f7
struct Spins
	N::Int32
	M::Int32
	A::Array{Float32}
...
# ╔═╡ 13b55ec2-55ab-4b49-8f59-6446ae5f3835
...
# ╔═╡ 7691d9ba-c603-4392-aed0-07de3dddfe0d
html"<br><br><br><br><br>"

# ╔═╡ 70a49555-095d-46ee-a692-419b40f21b9b
function EnergyParallel(S::Spins)
	E = zeros(Float32,S.N,S.M)
	p = [(-1,0),(1,0),(0,-1),(0,1)]
	for i in p
...
# ╔═╡ addd6a86-dd57-4f81-a08b-c495ac53b7b1
...
# ╔═╡ 746a034d-0480-4f6f-a79f-9f8ffdf75f41
...
# ╔═╡ eeef6073-3d0b-46e4-93fb-695d10a77ed1
...
# ╔═╡ e0120c8d-4c6e-4e0e-85d7-24da6c314dc0
...
# ╔═╡ 94409e6e-5fb8-4337-8762-9a6b56992c8f
begin
	N = 10000;
	X = Init(N,N)
	...
	A = CuArray(Init(N,N).A)
	B = CuArray(Init(N,N).A)
	
	println("Multiplication Times - ")
	@time *(a,b)
	@time *(A,B)
	println("Energy Calculation Times - ")
	@time EnergyParallel(X)
	@time EnergyGPU(X)
	@time EnergyGPUAlt(X)
	println("Magnetisation Calculation Times - ")
	@time Magnetisation(X)
	@time MagnetisationGPU(X)
end

# ╔═╡ d6e2321e-5d0c-4cda-9391-8ff194e1e84c
...
# ╔═╡ 30d1fa7f-dd6a-4302-a9fc-ad96bfca39fa
...
# ╔═╡ 8c03ccc2-586b-4091-ab7b-9e9b5eb5aaf2
@time Run(31,31,10000,1)
